...
```{r plot_license, echo=TRUE, fig.width=10,fig.height=11}
...
This is auto-populated from your ORCID profile using the @R-rorcid package. (cite the package).

[0000-0002-8974-5193](https://orcid.org/)
